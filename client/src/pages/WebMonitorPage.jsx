...
import { FaGlobe, FaSearch, FaExclamationCircle, FaCheckCircle, FaServer } from 'react-icons/fa';
...
const WebMonitorPage = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-matrix-fade">
            <header>
            ...
            {report && (
                <div className="space-y-6">
                    ...
                    <div className="glass-panel p-6 rounded-xl">
                        <h3 className="font-bold text-white mb-4">HEADER SECURITY ANALYSIS</h3>
